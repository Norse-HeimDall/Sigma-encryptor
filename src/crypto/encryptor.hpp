...
// Для статической линковки (как в нашем случае) макрос пустой
#ifdef _WIN32
    #ifdef SIGMA_EXPORTS
 ...
 * Он управляет различными алгоритмами и предоставляет
...
private:
     ...
     * 
     * PBKDF2 - это стандарт RSA Laboratories для генерации ключей
